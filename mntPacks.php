...
<script>
    ...
    tbPacks.data.load("toolbarsQy.php?t=p_aeds").then(function(){
    ...
    gridPacks = new dhx.Grid(null, {
        columns: [
            ...
            { width: 130, id: "bkCode", header: [{ text: "Code" }], gravity: 1.5, hidden: false},
            { id: "bkDesig", header: [{ text: "Designation" }], gravity: 1.5, hidden: false},
            { width: 150, id: "sfamName", header: [{ text: "Sub-family" }], gravity: 1.5, hidden: false},
            { width: 100, id: "BomKit", header: [{ text: "BOM / KIT" }], gravity: 1.5, hidden: false},
            { width: 50, id: "bkUnit", header: [{ text: "Un." }], gravity: 1.5, hidden: false},
         ],
        autoWidth: true,
        css: "alternate_row",
        selection: "row"
    ...
    gridPacks.events.on("cellClick", function(row,column,e){
        ...
        if(row.id !== ''){
            formProduct.clear();
            dhx.ajax.get("mntPacksQy.php?t=pack&r="+row.id).then(function (data) {
                obj = JSON.parse(data);
    ...
    function loadPacks() {
        gridPacks.data.load("mntPacksQy.php?t=packs").then(function(){    });
    };
    function loadPackDetails() {
        gridPackArt.data.load("mntPacksQy.php?t=detail&c="+wSelected).then(function(){
        });
    }
...
//            console.log(wDetType);
    ...
    function addEditPack(argument) {
        ...
        cbProdType.data.load("commonQy.php?t=fam&s=k").then(function(){
            dhx.ajax.get("mntPacksQy.php?t=pack&r="+wSelected).then(function (data) {
                console.log(data);
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("mntPacksWr.php?t=f&r="+wSelected, "POST").then(function(data){
//                            message = JSON.parse(data);
    ...
    function delete_line() {
        ...
        dhx.confirm(config).then(function(answer){
            if (answer) {
                dhx.ajax.get("mntPacksWr.php?t=del&id="+wSelDet).then(function (data) {
                    loadPackDetails();
                }).catch(function (err) {
                        console.log(err);
                });
    ...
    function add_l_line() {
        ...
        cbType.data.load("commonQy.php?t=fam&s=l").then(function(){
            if ( wSelDet != 0 ) {
                dhx.ajax.get("mntPacksQy.php?t=r&id="+wSelDet).then(function (data) {
                    var obj = JSON.parse(data);
                    console.log(obj);
                    form.setValue(obj);
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("mntPacksWr.php?t=d&l=l&e="+wSelected, "POST").then(function(data){
//                            message = JSON.parse(data);
//                            console.log(data);
                            loadPackDetails();
                            form.destructor();
    ...
    function add_s_line() {
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("mntPacksWr.php?t=d&l=s&e="+wSelected, "POST").then(function(data){
//                            message = JSON.parse(data);
                            console.log(data);
                            loadPackDetails();
                            form.destructor();
    ...
    function add_e_line() {
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("mntPacksWr.php?t=d&l=e&e="+wSelected, "POST").then(function(data){
//                            message = JSON.parse(data);
//                            console.log(data);
                            loadPackDetails();
                            form.destructor();
    ...
    function add_p_line() {
        ...
        cbType.data.load("commonQy.php?t=fam&s=p").then(function(){ 
            if ( wSelDet != 0 ) {
                dhx.ajax.get("mntPacksQy.php?t=p&id="+wSelDet).then(function (data) {
                    var obj = JSON.parse(data);
                    console.log(obj);
                    form.setValue(obj);
                    cbType.setValue(obj.estReference);
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("mntPacksWr.php?t=p&l=p&e="+wSelected, "POST").then(function(data){
//                            message = JSON.parse(data);
//                            console.log(data);
                            loadPackDetails();
                            form.destructor();
