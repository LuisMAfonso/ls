...
<script>
    ...
    dsBActivity = new dhx.DataCollection();
    loadPermission()
    
    function loadGrid() {
        dsBActivity.removeAll();
        dsBActivity.load("tbBActivityQy.php?t=grid").then(function(){
    ...
    function addEditUser(argument) {
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("tbBActivityWr.php?t=f", "POST").then(function(data){
//                            message = JSON.parse(data);
        ...
        dhx.ajax.get("tbBActivityQy.php?t=r&id="+wSelected).then(function (data) {
            console.log(data);
    ...
    function loadPermission() {
        dhx.ajax.get("menuQy.php?t=per&p=tbBActivity").then(function (data) {
            console.log(data);
            var obj = JSON.parse(data);
            console.log(obj);
            canRead = obj.canRead;
