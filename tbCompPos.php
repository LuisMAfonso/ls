...
<script>
    ...
    function loadGrid() {
        ...
        dsBActivity.load("tbCompPosQy.php?t=grid").then(function(){
    ...
    function addEditUser(argument) {
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("tbCompPosWr.php?t=f", "POST").then(function(data){
//                            message = JSON.parse(data);
        ...
        dhx.ajax.get("tbCompPosQy.php?t=r&id="+wSelected).then(function (data) {
            console.log(data);
    ...
    function loadPermission() {
        dhx.ajax.get("menuQy.php?t=per&p=tbCompPos").then(function (data) {
            console.log(data);
            var obj = JSON.parse(data);
            console.log(obj);
            canRead = obj.canRead;
