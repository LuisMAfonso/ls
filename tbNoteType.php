...
<script>
    ...
    dsNoteType = new dhx.DataCollection();
    loadPermission()
    
    function loadGrid() {
        dsNoteType.removeAll();
        dsNoteType.load("tbNoteTypeQy.php?t=grid").then(function(){
    ...
    function addEditUser(argument) {
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("tbNoteTypeWr.php?t=f", "POST").then(function(data){
//                            message = JSON.parse(data);
        ...
        dhx.ajax.get("tbNoteTypeQy.php?t=r&id="+wSelected).then(function (data) {
            console.log(data);
    ...
    function loadPermission() {
        dhx.ajax.get("menuQy.php?t=per&p=tbNoteType").then(function (data) {
            console.log(data);
            var obj = JSON.parse(data);
            console.log(obj);
            canRead = obj.canRead;
