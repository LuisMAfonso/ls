...
<script>
    ...
    dsPrjStatus = new dhx.DataCollection();
    loadPermission()
    
    function loadGrid() {
        dsPrjStatus.removeAll();
        dsPrjStatus.load("tbPrjStatusQy.php?t=grid").then(function(){
    ...
    pGrid = new dhx.Grid(null, {
        columns: [
            ...
            { width: 60, id: "statusType", header: [{ text: "Order" }], autoWidth: true, align: "right" },
    ...
    function addEditUser(argument) {
        ...
        const form = new dhx.Form(null, {
            ...
            rows: [
                ...
                { type: "input", name: "icon", required: false, label: "Icon", labelPosition: "left", labelWidth: "80px", },
        ...
        form.events.on("click", function(name,e){
            ...
            if ( name == 'send' ) {
                ...
                dhx.confirm(config).then(function(answer){
                    if (answer) {
                        const send = form.send("tbPrjStatusWr.php?t=f", "POST").then(function(data){
//                            message = JSON.parse(data);
        ...
        dhx.ajax.get("tbPrjStatusQy.php?t=r&id="+wSelected).then(function (data) {
            console.log(data);
    ...
    function loadPermission() {
        dhx.ajax.get("menuQy.php?t=per&p=tbPrjStatus").then(function (data) {
            console.log(data);
            var obj = JSON.parse(data);
            console.log(obj);
            canRead = obj.canRead;
